"""SFT 後のモデル(LoRA アダプタ)に対し DPO を行う。

unsloth + trl の DPOTrainer を使用。
"""
...
def main() -> None:
    ...
    ap.add_argument("--adapter", default=None, help="SFT で得た LoRA adapter のパス(オプション)")
    ...
    print(f"[OK] DPO done -> {args.output_dir}")
